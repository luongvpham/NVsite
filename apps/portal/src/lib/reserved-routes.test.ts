 ...
 * Test này khẳng định phía FE (portal) đọc đúng file và có cùng nội dung bắt buộc mà
 * backend/tests/ArchitectureTests/ReservedRoutesTests.cs cũng khẳng định phía BE,
 * và apps/web/src/lib/reserved-routes.test.ts khẳng định phía apps/web.
 */
describe('reserved-routes.json (portal)', () => {

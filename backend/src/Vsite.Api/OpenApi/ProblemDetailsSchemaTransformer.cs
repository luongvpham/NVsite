...
/// <summary>
/// <c>error_code</c> được gắn vào ProblemDetails qua <c>Extensions</c> lúc runtime
/// (Api.ExceptionHandling.AppExceptionHandler/UnauthorizedAccessExceptionHandler) — Microsoft.AspNetCore.OpenApi không tự suy ra field này

...
/// </summary>
public sealed class ResetPasswordHandler(IAppDbContext db, IPasswordHasher<Vsite.Domain.Identity.Entities.User> passwordHasher, IJwtTokenService tokenService, IEmailSender emailSender)

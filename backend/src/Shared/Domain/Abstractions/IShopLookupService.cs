...
/// <summary>
/// Tra `ShopId` theo slug — dùng bởi `Api.Tenancy.TenantResolutionMiddleware` để resolve tenant từ
...
/// thật (query bảng Shop) nằm ở Identity.Infrastructure, đăng ký qua DI như các service khác.
